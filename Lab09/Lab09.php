...
<body>
   ...
   //              </a>
          ...
          foreach ( $images as $key => $value) {
              echo '<li><a href='."details.php?id=".$key.' class="img-responsive"><img src='."images/square/".$value["path"].
                  ' alt='.$value["title"].'><div class="caption"><div class="blur"></div><div class="caption-text"><h1>'.
